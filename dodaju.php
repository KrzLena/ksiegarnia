...
if (isset($_POST['create_user'])) {
    ...
    if (mysqli_query($ksiegarnia, $sql_create_user)) {
        echo "<script>alert('Użytkownik został pomyślnie utworzony.');</script>";
        
        echo "<script>window.location.replace('dodaju.php');</script>";
        exit();
    } else {
...
if (isset($_GET['delete_user'])) {
    ...
    if (mysqli_query($ksiegarnia, $sql_delete_user)) {
    ...
    <script>
        function deleteUser(userId) {
            if (confirm("Czy na pewno chcesz usunąć tego użytkownika?")) {
                ...
                window.location.href = "dodaju.php?delete_user=" + userId;
            }
        }
    </script>
<br><br>
