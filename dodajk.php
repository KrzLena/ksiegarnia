...
if(isset($_POST['create_book'])) {
    ...
    if(mysqli_query($ksiegarnia, $sql_create_book)) {
        $_SESSION['success_message'] = 'Książka została pomyślnie dodana.';
        header("Location: dodajk.php");
        exit();
    } else {
...
if(isset($_GET['delete_book'])) {
    ...
    if(mysqli_query($ksiegarnia, $sql_delete_book)) {
    ...
    <script>
        function deleteBook(bookId) {
            if (confirm("Czy na pewno chcesz usunąć tę książkę?")) 
            {
                ...
                window.location.href = "dodajk.php?delete_book=" + bookId;
            }
        }
    </script>
<br><br>
